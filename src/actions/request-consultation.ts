...
export async function requestConsultation(
  ...
  try {
    const mailOptions = {
      from: "superkos_hugh@naver.com", // 발신자 이메일 주소.
      // from: "herrymh@naver.com",
      to: "hugh.lee@superkos.co", //사용자가 입력한 이메일 -> 목적지 주소 이메일
      // to: "herrymh@naver.com",
      subject: "[보네르 빌리지] 상담 신청하기",
      html: `
    <div
  style="
...
>
  ...
  >
    ...
    <div style="font-size: 16px; line-height: 1.6">
      <p>안녕하세요,</p>
      <p>아래 고객 정보를 보네르 빌리지 홈페이지에서 수집했습니다.</p>
      <table
        style="
          width: 100%;
    ...
    >
      <p>
        본 메일은 Bouheur Village 웹사이트를 통해 수집된 정보를 바탕으로
        발송되었습니다.
      </p>
    </div>
  </div>
